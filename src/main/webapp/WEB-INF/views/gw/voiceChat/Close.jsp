...
.closeMeeting{font-size: 80px;color: white;font-family: 'ON-IGothic';}
#closeDiv{padding-top: 300px;}
</style>

</head>
<body>
<div class="text-center" id="closeDiv">
<h2 class="closeMeeting">회의가 종료되었습니다.</h2>
<button type="button" class="btn btn-primary btn-lg" id="colse_meeting" onclick="window.close();">창 닫기</button>
</div>
</body>
</html>
