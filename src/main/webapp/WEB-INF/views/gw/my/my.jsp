...
<jsp:include page="/WEB-INF/views/common/gw_header.jsp">
 ...
 <div class="test-notice-outter">
  <div class="test-my-title-container">
    ...
    <div class="test-my-select">
      <select class="form-select" aria-label="Default select example">
        ...
        <option value="2">작성일수</option>
        <option value="3">첨부파일 유무</option>
      </select>
      <select class="form-select" aria-label="Default select example">
        <option selected>전체검색</option>
        <option value="1">제목 검색</option>
        <option value="2">내용 검색</option>
        
      </select>
      
    </div>
    <div class="test-my-search">
      <input type="text">
